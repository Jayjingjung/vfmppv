...
<!-- ນໍ້າໜັກທັງໝົດ -->
                        <div style="width:100%" class="pl-2">
                            <span>ນໍ້າໜັກລົດເປົ່າ</span>
                            <v-text-field flat solo dense background-color="#f5f5f5" placeholder="ປ້ອນນ້ຳໜັກລົດເປົ່າ"
                                v-model="numnuklod"></v-text-field>
                        </div>
                        <div style="width:100%" class="pl-2">
                            <span>ນໍ້າໜັກສິນຄ້າ</span>
                            <v-text-field flat solo dense background-color="#f5f5f5" placeholder="ປ້ອນນໍ້າໜັກສິນຄ້າ"
                                append-icon="mdi-format-title" v-model="proSize"></v-text-field>
                        </div>
                        <div style="width:100%" class="pl-2">
                            <span>ນໍ້າໜັກທັງໝົດ</span>
                            <v-text-field flat solo dense background-color="#f5f5f5" placeholder="ປ້ອນນໍ້າໜັກທັງໝົດ"
...
<!-- ເລືອກວັນກຳນົດເກັບເງິນ -->
                <div style="width:15%">
                            <v-menu ref="dpay_Moneyy" v-model="dpay_Moneyy" :close-on-content-click="false"
                                ...
                                <template v-slot:activator="{ on, attrs }">
                                    <span>ວັນທີເກັບເງິນເບ້ຍລ້ຽງ</span>
                                    <v-text-field v-model="dpay_Money" dense flat solo background-color="#f5f5f5"
                        ...
                        <v-data-table :items="report_peration_list" :headers="report_operation_header" :search="search">
                            <template v-slot:item="row">
                                ...
                                <tr :style="{ 'color': row?.item?.totalDay >= '7' ? 'red' : 'black' }">
                                    ...
                                    <!-- <td class="red--text font-weight-bold">{{ row?.item?.price }} {{ row?.item?.currency }}</td> -->
        ...
        <br>
                ...
                <div style="display:flex;justify-content:end;flex-direction:column;align-items:end">
                    ...
                    <div style="border:0.5px solid #999;display:flex;flex-direction:column;padding:10px;border-radius:3px">
                        ...
                        <span style="font-size:12px">ກຳນົດເກັບເງິນເບ້ຍລ້ຽງ:
                ...
                <div style="padding-top:20px;display:flex;flex-direction:row;justify-content:space-between; font-size:12px">
                    <div>
                        <table style="padding:2px;border: 0.5px solid #FFF;border-collapse: collapse;width:100%">
                            ...
                            <tr style="padding:5px;border: 0.5px solid #999;">
                                <td style="border: 0.5px solid #999;padding:5px">ຄ່າເອົາຕູ້ອອກຈາກດ່ານລາວ</td>
                                <td style="border: 0.5px solid #999;padding:5px">{{
...
export default {
    ...
    watch: {
        ...
        proSize: function (newValue) {
            ...
            this.numnuktotal = totalNumnuk?.toString()?.replace(/\D/g, '')?.replace(/\B(?=(\d{3})+(?!\d))/g, ',')
