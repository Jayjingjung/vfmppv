                ...
                <v-card flat>
                    ...
                    <v-card-text>
                        ...
                        <v-row>
                            ...
                            <v-col clos="6" md="3" sm="3">
                                <v-text-field  label="ກໍານົດປ່ຽນນໍ້າມັນເກຍ (ຕາມເລກໄມ)" dense outlined
                                    background-color="#f5f5f5" v-model="leanGia"></v-text-field>
                                <div class="tops">
                                </div>
                            </v-col>
                            <v-col clos="6" md="3" sm="3">
                                <v-text-field  label="ກໍານົດປ່ຽນນ້ຳມັນເຟືອງທ້າຍ (ຕາມເລກໄມ)" dense outlined
                ...
                <v-card flat>
                    <v-card-text>
                        ...
                        <div style="background-color:#f2ebeb;height:80px;padding-top:5px;border-radius:5px"
                            ...
                            <div class="d-flex" style="margin-top:-10px">
                                <v-text-field :rules="nameRules" rounded dense background-color="#fff" label="ເລກໄມລ່າສຸດ"
                                    v-model="h_KM13"></v-text-field>
                                <v-text-field :rules="nameRules" rounded dense background-color="#fff" label="ເລກໄມປະຈຸບັນ"
                                    v-model="h_KML_13" readonly></v-text-field>
                                <v-text-field :rules="nameRules" rounded background-color="#fff" dense label="ແລ່ນໄປແລ້ວ km"
                                    readonly v-model="canRun13"></v-text-field>
                            </div>
                        </div>
                    </v-card-text>
                </v-card>
