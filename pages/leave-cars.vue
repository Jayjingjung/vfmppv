<template>
 ...
 <!-- choose emp1 and emp2 -->
          <div class="d-flex align-center mt-6">
            ...
            <div style="background-color:#f5f5f5;width:100%;border-radius:5px" class="pa-4">
              <div>
                <v-autocomplete outlined dense label="ເລືອກຄົນຂັບ2" :items="emplyee_list02" item-text="name" item-value="id"
                  @change="onGetEmployeeListStaff02"></v-autocomplete>
              </div>
          ...
          <div class="d-flex align-center mt-6 mb-6">
            ...
            <div style="width:100%;background-color:#f5f5f5;border-radius:5px" class="pa-4">
              <div class="d-flex align-center">
                <div style="width:100%">
                  <v-text-field label="ເບ້ຍລ້ຽງ" outlined dense v-model="money1"></v-text-field>

                </div>
                <div style="width:100%" class="d-flex align-center pl-2">
                  <v-text-field label="ເບ້ຍລ້ຽງຈ່າຍກ່ອນ" outlined dense v-model="money_aready_pay1"></v-text-field>
                </div>
              </div>
              <div class="d-flex align-center">
                <div class="d-flex align-center" style="width: 100%">
                  <v-text-field readonly label="ຄ້າງຈ່າຍ" style="width:100%" outlined dense
                    v-model="money_still_pay1"></v-text-field>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <v-menu ref="start_go_menu" v-model="start_go_menu" :close-on-content-click="false"
                    ...
                    <template v-slot:activator="{ on, attrs }">
                      <v-text-field  dense outlined v-model="start_go_date" required label="ວັນທີອອກເດີນທາງ"
                        append-icon="mdi-calendar" readonly v-bind="attrs" v-on="on" :rules="nameRules" 
                      ></v-text-field>
                    </template>
          ...
          <div>
            ...
            <div style="width:100%" class="pt-4">
              ...
              <div style="display:flex;justify-content:space-between">
                ...
                <div style="width:100%"><v-text-field outlined background-color="#f5f5f5" dense label="ຄ່າແຈ້ງເອກະສານຢູ່ບ່ອນຂຶ້ນເກືອ"
                    v-model="Feesaphan"></v-text-field>
                </div>
                <div style="width:100%" class="pl-2">
          ...
          <table style="padding:2px;border: 0.5px solid #999;border-collapse: collapse;width:100%" class="mt-4">
            ...
            <tr>
              <td colspan="2"
                ...
                <v-row>
                  ...
                  <v-col cols="9">
                    <div style="display:flex;flex-direction:row;justify-content:space-between;">
                      <div style="width:100%"><span style="font-size:12px">ຄົນຂັບ1: {{ emp_name }} {{ surnamee }} </span></div>
                    </div>
                    <div style="display:flex;flex-direction:row;justify-content:space-between;">
              ...
              <td colspan="2"
                ...
                <v-row>
                  ...
                  <v-col cols="9">
                    <div style="display:flex;flex-direction:row;justify-content:space-between;">
                      <div style="width:100%"><span style="font-size:12px">ຄົນຂັບ2: {{ emp_name1 }} {{ surnamee1 }}</span></div>
                    </div>
                    <div style="display:flex;flex-direction:row;justify-content:space-between;">
            ...
            <tr
              ...
              <td colspan="2"
                ...
                class="font-weight-bold">
                <div style="width:100%;display:flex;justify-content:end">
                  <span>{{ (parseFloat(money_aready_pay ? money_aready_pay?.split(',').join(''):0) + parseFloat(money_aready_pay1 ? money_aready_pay1?.split(',').join(''):0))?.toString()?.replace(/\D/g, '')
                    .replace(/\B(?=(\d{3})+(?!\d))/g, ',') }} {{ currency1 }}</span>
                </div>
              </td>
            </tr>
            <tr
              ...
              <td colspan="2"
                ...
                class="font-weight-bold">
                <div style="width:100%;display:flex;justify-content:end">
                  <span>{{ (parseFloat(money_aready_pay ? money_aready_pay?.split(',').join(''):0) + parseFloat(money_aready_pay1 ? money_aready_pay1?.split(',').join(''):0)+parseFloat(priceNamMun_Total ? priceNamMun_Total?.split(',').join(''):0))?.toString()?.replace(/\D/g, '')
            ...
            <table style="padding:2px;border: 0.5px solid #999;border-collapse: collapse;width:100%">
              ...
              <tr
                ...
                <td
                  style="padding:10px;border: 0.5px solid #999;border-collapse: collapse;color:#000;border-top-right-radius:3px">
                  <div style="width:100%;display:flex;justify-content:space-between">
                    <span>{{ parseFloat(ll_TIRE_KM_1?.split(',')?.join('')) - parseFloat(road_send_km?.split(',')?.join(''))
                    }}</span>
                  </div>
                </td>
              </tr>
              <tr
                ...
                <td
                  style="padding:10px;border: 0.5px solid #999;border-collapse: collapse;color:#000;border-top-right-radius:3px">
                  <div style="width:100%;display:flex;justify-content:space-between">
                    <span>{{ parseFloat(ll_TIRE_KM_2?.split(',')?.join('')) - parseFloat(road_send_km?.split(',')?.join(''))
                    }}</span>
                  </div>
                </td>
              </tr>
              <tr
                ...
                <td
                  style="padding:10px;border: 0.5px solid #999;border-collapse: collapse;color:#000;border-top-right-radius:3px">
                  <div style="width:100%;display:flex;justify-content:space-between">
                    <span>{{ parseFloat(ll_TIRE_KM_3?.split(',')?.join('')) - parseFloat(road_send_km?.split(',')?.join(''))
                    }}</span>
                  </div>
                </td>
              </tr>
              <tr
                ...
                <td
                  style="padding:10px;border: 0.5px solid #999;border-collapse: collapse;color:#000;border-top-right-radius:3px">
                  <div style="width:100%;display:flex;justify-content:space-between">
                    <span>{{ parseFloat(ll_TIRE_KM_4?.split(',')?.join('')) - parseFloat(road_send_km?.split(',')?.join(''))
                    }}</span>
                  </div>
                </td>
              </tr>
              <tr v-if="ll_TIRE_NO_5"
                ...
                <td
                  style="padding:10px;border: 0.5px solid #999;border-collapse: collapse;color:#000;border-top-right-radius:3px">
                  <div style="width:100%;display:flex;justify-content:space-between">
                    <span>{{ parseFloat(ll_TIRE_KM_5?.split(',')?.join('')) - parseFloat(road_send_km?.split(',')?.join(''))
                    }}</span>
                  </div>
                </td>
              </tr>
              <tr v-if="ll_TIRE_NO_6"
                ...
                <td
                  style="padding:10px;border: 0.5px solid #999;border-collapse: collapse;color:#000;border-top-right-radius:3px">
                  <div style="width:100%;display:flex;justify-content:space-between">
                    <span>{{ parseFloat(ll_TIRE_KM_6?.split(',')?.join('')) - parseFloat(road_send_km?.split(',')?.join(''))
                    }}</span>
                  </div>
                </td>
              </tr>
              <tr
                ...
                <td
                  style="padding:10px;border: 0.5px solid #999;border-collapse: collapse;color:#000;border-top-right-radius:3px">
                  <div style="width:100%;display:flex;justify-content:space-between">
                    <span>{{ parseFloat(r_TIRE_KM_1?.split(',')?.join('')) - parseFloat(road_send_km?.split(',')?.join(''))
                    }}</span>
                  </div>
                </td>
              </tr>
              <tr
                ...
                <td
                  style="padding:10px;border: 0.5px solid #999;border-collapse: collapse;color:#000;border-top-right-radius:3px">
                  <div style="width:100%;display:flex;justify-content:space-between">
                    <span>{{ parseFloat(r_TIRE_KM_2?.split(',')?.join('')) - parseFloat(road_send_km?.split(',')?.join(''))
                    }}</span>
                  </div>
                </td>
              </tr>
              <tr
                ...
                <td
                  style="padding:10px;border: 0.5px solid #999;border-collapse: collapse;color:#000;border-top-right-radius:3px">
                  <div style="width:100%;display:flex;justify-content:space-between">
                    <span>{{ parseFloat(r_TIRE_KM_3?.split(',')?.join('')) - parseFloat(road_send_km?.split(',')?.join(''))
                    }}</span>
                  </div>
                </td>
              </tr>
              <tr
                ...
                <td
                  style="padding:10px;border: 0.5px solid #999;border-collapse: collapse;color:#000;border-top-right-radius:3px">
                  <div style="width:100%;display:flex;justify-content:space-between">
                    <span>{{ parseFloat(r_TIRE_KM_4?.split(',')?.join('')) - parseFloat(road_send_km?.split(',')?.join(''))
                    }}</span>
                  </div>
                </td>
              </tr>
              <tr
                ...
                <td
                  style="padding:10px;border: 0.5px solid #999;border-collapse: collapse;color:#000;border-top-right-radius:3px">
                  <div style="width:100%;display:flex;justify-content:space-between">
                    <span>{{ parseFloat(r_TIRE_KM_5?.split(',')?.join('')) - parseFloat(road_send_km?.split(',')?.join(''))
                    }}</span>
                  </div>
                </td>
              </tr>
              <tr
                ...
                <td
                  style="padding:10px;border: 0.5px solid #999;border-collapse: collapse;color:#000;border-top-right-radius:3px">
                  <div style="width:100%;display:flex;justify-content:space-between">
                    <span>{{ parseFloat(r_TIRE_KM_6?.split(',')?.join('')) - parseFloat(road_send_km?.split(',')?.join(''))
                    }}</span>
                  </div>
                </td>
              </tr>
...
emplyee_list02: [],
  ...
  methods: {
    ...
    async onGetEmployeeListStaff022() {
      try {
        this.loading_processing = true
        await this.$axios.$post('getChooseStaft02.service').then((data) => {
          this.loading_processing = false
